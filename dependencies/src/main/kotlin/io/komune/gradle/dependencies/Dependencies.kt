...
object FixersVersions {
	...
	object Spring {
		...
		const val data = "3.4.1"
		const val framework = "6.2.1"
		const val security = "6.4.2"
		const val jakartaPersistence = "3.2.0"
		const val reactor = "3.7.1"
	}
