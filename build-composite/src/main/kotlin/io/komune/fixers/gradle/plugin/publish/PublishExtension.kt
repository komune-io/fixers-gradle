 ...
 */
fun Project.publishing(configure: PublishConfiguration.() -> Unit = {}): PublishConfiguration {
	val extension = extensions.findByType(PublishConfiguration::class.java) ?:
	extensions.create("publishingConfig", PublishConfiguration::class.java, this)
